...
COMMANDS:
  ...
  hd generate-mnemonic  Generate an ebp-hd-v1 mnemonic using BIP39 English words
    --strength <bits>   Entropy bits: 128, 160, 192, 224, or 256
  hd verify-mnemonic    Validate an ebp-hd-v1 mnemonic using BIP39 English words
